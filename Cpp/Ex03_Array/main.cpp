...
int main()
{
    ...
    // cout << my_array[10000] << endl; // Bus error 또는 Segmentation fault


    // 문자열은 기본적으로 문자의 배열
    // char name[75] = "Hello, World!"; // 문자''와 문자열"" 구분
    // char name[14] = "Hello, World!"; // 문자''와 문자열"" 구분
    char name[] = "Hello, World!"; // 배열 크기를 지정해주지 않아도 컴파일러가 알아서 초깃값 지정해줌
    // Null character '\0'
    ...
    cout << name << endl; // 추측해보세요. 한 글자씩 출력을 하다가 Null character '\0'을 만나면 멈추는 식으로 작동함
